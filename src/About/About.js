	...
	return (
		<section className="About">
			<article className="summary">
				...
				<p><span className="title-word">brewfinder</span> was designed for avid beer lovers in the state of Colorado! We provide access to hundreds of breweries in Colorado. You have the ability to search by city, filter by brewery type or simply view them all! Click the 'view details' button on each brewery listed to see their address, phone number and a link to their website. Also, please favorite the breweries you know and love so you can easily come back to them! Cheers!</p>
			</article>
